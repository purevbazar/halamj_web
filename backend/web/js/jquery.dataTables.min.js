...
d[c]=e,"o"===b[1]&&Y(a[e])});a._hungarianMap=d}function J(a,b,c){a._hungarianMap||Y(a);var d;h.each(b,function(e){d=a._hungarianMap[e];if(d!==k&&(c||b[d]===k))"o"===d.charAt(0)?(b[d]||(b[d]={}),h.extend(!0,b[d],b[e]),J(a[d],b[d],c)):b[d]=b[e]})}function Fa(a){var b=m.defaults.oLanguage,c=a.sZeroRecords;!a.sEmptyTable&&(c&&"Хоосон байна!"===b.sEmptyTable)&&F(a,a,"sZeroRecords","sEmptyTable");!a.sLoadingRecords&&(c&&"Loading..."===b.sLoadingRecords)&&F(a,a,"sZeroRecords","sLoadingRecords");
...
oPaginate:{sFirst:"Эхний",sLast:"Сүүлийн",sNext:"Дараагийн",sPrevious:"Өмнөх"},sEmptyTable:"Хоосон байна!",sInfo:"Нийт _TOTAL_ мэдээнээс _START_ -ээс _END_ -г үзүүлж байна",sInfoEmpty:"Нийт 0 мэдээнээс 0 -ээс 0 -г үзүүлж байна",sInfoFiltered:"(filtered from _MAX_ total entries)",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"",sLoadingRecords:"Loading...",sProcessing:"Processing...",sSearch:"Шүүх",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"Хайлт илэрцгүй"},oSearch:h.extend({},
...
" ui-corner-bl ui-corner-br"});var Mb=m.ext.pager;h.extend(Mb,{simple:function(){return["previous","next"]},full:function(){return["Эхний","Хоёрдугаар","Дараагийн","Сүүлийнх"]},numbers:function(a,b){return[Aa(a,b)]},simple_numbers:function(a,b){return["previous",Aa(a,b),"next"]},full_numbers:function(a,b){return["first","previous",Aa(a,b),"next","last"]},_numbers:Aa,numbers_length:7});h.extend(!0,m.ext.renderer,{pageButton:{_:function(a,b,c,d,e,f){var g=a.oClasses,j=a.oLanguage.oPaginate,i=a.oLanguage.oAria.paginate||
